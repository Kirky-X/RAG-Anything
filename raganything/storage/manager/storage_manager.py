...
class StorageManager:
    ...
    async def store_model(self, model_name: str, file_path: str, version: str = "latest") -> str:
        """
        Store a model file.
    ...
    async def store_rag_data(self, data_type: str, content: bytes, source_doc_id: str) -> str:
        """
